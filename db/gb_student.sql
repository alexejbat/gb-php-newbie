...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 31 2022 г., 16:22
...
(1, 'sudak.jpg', 'Судак вяленый', 'Астраханский вяленый судак в домашних уютных посиделках становится главным блюдом. ', 900, 0),
(2, 'sopa.jpg', 'Сопа вяленая', 'Сопа приготовлена по традиционным астраханским рецептам вяления', 700, 0),
(3, 'lesh.jpg', 'Лещ вяленый', 'Крупная (25+ см) мясистая рыбка лоснится жиром, брюшко наполнено отменной икрой с пикантной горчинкой.', 550, 0),
(4, 'Chehon.jpg', 'Чехонь вяленая', 'Из чехони готовят много блюд — но наиболее вкусным вариантом является засоленная чехонь, вяленая по старинным астраханским рецептам. ', 900, 0),
...
(7, 'ikra_vobla.jpg', 'Икра воблы вяленая', 'Икра воблы вяленая в тубусе — идеальный презент для ценителя солёненького по любому случаю.', 1250, 0),
(8, 'company.jpg', 'Набор \"Компанейский\"', 'Намечается дружеская посиделка в сопровождении пенных напитков? Тогда рекомендуем обратить внимание на набор «Компанейский» ', 4300, 0),
